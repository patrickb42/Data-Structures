...
class DoublyLinkedListTests(unittest.TestCase):
    ...
    def test_list_add_to_tail(self):
        ...
        self.assertEqual(self.dll.tail.prev_node.value, 1)
        self.assertEqual(self.dll.tail.value, 30)
        self.assertEqual(len(self.dll), 2)

        self.dll.add_to_tail(20)
        self.assertEqual(self.dll.tail.prev_node.value, 30)
        self.assertEqual(self.dll.tail.value, 20)
        self.assertEqual(len(self.dll), 3)

    def test_node_delete(self):
        node_1 = DoublyLinkedList._Node(3)
        node_2 = DoublyLinkedList._Node(4)
        node_3 = DoublyLinkedList._Node(5)
        ...
        self.assertEqual(node_3.prev_node, node_1)

    def test_node_insert_before(self):
        self.node.insert_before(0)
        self.assertEqual(self.node.prev_node.value, 0)
    ...
    def test_list_add_to_head(self):
        ...
        self.assertEqual(self.dll.head.next_node.value, 1)
        self.assertEqual(len(self.dll), 2)

    def test_node_insert_after(self):
        self.node.insert_after(2)
        self.assertEqual(self.node.next_node.value, 2)
    ...
    def test_list_move_to_end(self):
        ...
        self.dll.move_to_end(self.dll.head.next_node)
        self.assertEqual(self.dll.tail.value, 40)
        self.assertEqual(self.dll.tail.prev_node.value, 4)
        self.assertEqual(len(self.dll), 3)
    ...
    def test_list_move_to_front(self):
        ...
        self.dll.move_to_front(self.dll.head.next_node)
        self.assertEqual(self.dll.head.value, 3)
        self.assertEqual(self.dll.head.next_node.value, 29)
        self.assertEqual(len(self.dll), 3)
