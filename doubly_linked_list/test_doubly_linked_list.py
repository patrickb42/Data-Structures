...
class DoublyLinkedListTests(unittest.TestCase):
    ...
    def test_node_delete(self):
        node_1 = DoublyLinkedListNode(3)
        node_2 = DoublyLinkedListNode(4)
        node_3 = DoublyLinkedListNode(5)
